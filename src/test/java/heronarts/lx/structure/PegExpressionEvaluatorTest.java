...
/**
 * Unit tests for PegExpressionEvaluator functionality.
 * This class runs the EXACT same test suite as ExpressionEvaluatorTest 
 * but using PegExpressionEvaluator instead of StringExpressionEvaluator.
 * 
 * This allows for direct comparison of the two implementations to ensure
 * they produce identical results for all test cases.
 */
public class PegExpressionEvaluatorTest {

    private ExpressionEvaluator evaluator;

    @BeforeEach
    void setUp() {
        evaluator = new PegExpressionEvaluator();
    }
    ...
    // EXACT SAME TEST METHODS AS ExpressionEvaluatorTest
    // This ensures direct comparison between StringExpressionEvaluator and PegExpressionEvaluator
