 ...
 *
 * <p>This interface provides methods to evaluate string expressions and return results as either
 * numeric (float) or boolean values. Implementations should support standard mathematical
 * operations, boolean logic, comparisons, parentheses, and conditional operators.
 */
public interface ExpressionEvaluator {
  ...
  /**
   * Expressions can have ambiguous types when nested with parentheses! This is getting out of
   * control and I really should have just used a proper expression parsing library of some sort
   * (-mcslee, June 2025, and yet bound to continue bolting onto this...)
   *
  ...
  /**
   * Base class for expression evaluation results. Results can be either numeric (float) or boolean
   * values.
   */
